...
import { ReusableTable } from "@/components/tables/reusable-data-table";
import { caseInsensitiveText } from "@/utils/data-table-filters";
  ...
  return (
    <>
      <div className="mb-6 flex flex-col lg:flex-row lg:items-center items-start justify-between gap-4 w-full">
        <h3 className="text-xl font-bold uppercase">Liste des homes</h3>
